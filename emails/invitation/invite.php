<?php
	...
	$message = <<<EOD
		...
		<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"
			style="margin: 0 auto !important; padding: 0 !important; height: 100% !important; width: 100% !important; background: #f1f1f1;"
		>
		<head>
		...
		*[x-apple-data-detectors],  /* iOS */
		...
		<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #222222;  margin: 0 auto !important; padding: 0 !important; height: 100% !important; width: 100% !important; background: #f1f1f1; 	font-family: 'Nunito Sans', sans-serif;	font-weight: 400; font-size: 15px; line-height: 1.8; color: rgba(0,0,0,.4);">
		    ...
		    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
		    	<!-- BEGIN BODY -->
		      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="   border-spacing: 0 !important; border-collapse: collapse !important; table-layout: fixed !important; margin: 0 auto !important; margin: auto;">
		      	<tr>
			      ...
			      <tr>
			        <td valign="middle" style="padding:2.5em; text-align:center; background: #800000">
			        	<div class="heading-section heading-section-white">
			          	<h2 style="color: #000000; font-size: 24px; margin-top: 0; line-height: 1.4; font-weight: 700; font-family: 'Nunito Sans', sans-serif; color: #000000;	margin-top: 0; color:white;">Invitation</h2>
			          	</div>
			        </td>
			       <tr>
			      ...
			      <tr>      
					<td valign="middle" class="footer" style="padding:2.5em; background: #340404; color: rgba(255,255,255,.5);">
		                  ...
		                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
		                    <tr>
		                      <td style="text-align: left; padding-right: 10px;">
		                      	<p><center>&copy; 2019 hansedido. All Rights Reserved</center></p>
		                      </td>
		                    </tr>
		                  </table>
		                </td>
