<?php
	...
	while(! feof($file)) {
		...
		$message = "{USER}, YOU ARE INVITED to our wedding on February 25! Please confirm attendance via our website, http://hansedido.com before January 18. You may also check your email for more details. Thanks! - Jhesed and Hannah";
